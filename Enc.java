...
public void actionPerformed(ActionEvent e) {button5_actionPerformed(e);}});
...
//Run Scrollbar          
		...
		void Encryt() throws IOException,FileNotFoundException
		{
			   ...
			   { 
                               ...
                               if (n!=-1)
                              {
                                  System.out.println( "ascii value of plain text"+     n);
                                    System.out.println("plain text"+    (char)n);
                                  char ch = (char)((n+s)%128);
                                  
                                  System.out.println("ascii value of cipher text "+      (int)ch);
                                  System.out.println("cipher text"+      ch);
                                   int i = ch;
                                   ou.write(i);
